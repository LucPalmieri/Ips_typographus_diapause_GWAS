...
g_baypass -gfile phenotyped.geno -efile contrast_PCA.txt -seed 1234 -npilot 15 -pilotlength 500 -burnin 2500 -nthreads 4 -outprefix phenotyped_importance_sampling_cov_run1 ;
